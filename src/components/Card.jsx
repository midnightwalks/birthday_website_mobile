  ...
  return (
    ...
    <div className="w-[400px]  h-screen flex flex-col items-center justify-center">
      ...
      <div id="card" className={`${cardClass}`} onClick={toggleCard}>     
        <div id="card-inside">
          <div className="wrap">
            <p>happy birthday pacarkuu</p>
            <p>happy 23 years old! semoga di umur yang baru ini michaelku makin dewasa, makin ganteng, makin sayang aku (muehehe) </p>
            <p>
            ...
            <p className="signed">jellie jellie</p>
          </div>
        </div>

        <div id="card-front">
          <div className="wrap">
            <h1>happy birthday cayaang</h1>
          </div>
        </div>
    </div>
